...
const ALLOWD_PATH = new Set(Object.values(HuggingFace));
...
async function handle(
  ...
  if (!ALLOWD_PATH.has(subpath)) {
    console.log("[HuggingFace Route] forbidden path ", subpath);
  ...
  const authResult = auth(req, ModelProvider.StableDiffusion);
  if (authResult.error) {
...
async function request(req: NextRequest) {
  ...
  let authValue =
    ...
    serverConfig.huggingFaceApiKey ||
    "";
  ...
  console.log("[HuggingFace request]", fetchOptions.headers, req.method);
  try {
