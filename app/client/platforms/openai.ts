    ...
    if (
      ...
      try {
        ...
        const formattedError =
          Locale.Error.TextModerationErr + `\n${errorMessage}`;
      ...
      if (shouldStream) {
        ...
        fetchEventSource(chatPath, {
          ...
          async onopen(res) {
            ...
            console.log(
              `[ServiceProvider] [${provider}] request response content type: `,
              contentType,
            );
          ...
          onmessage(msg) {
            ...
            try {
              ...
              if (
                ...
                console.log(
                  `[${provider}] [Text Moderation] flagged categories result:`,
